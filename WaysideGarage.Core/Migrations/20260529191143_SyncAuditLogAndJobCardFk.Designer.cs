...
namespace WaysideGarage.Core.Migrations
{
    ...
    [Migration("20260529191143_SyncAuditLogAndJobCardFk")]
    partial class SyncAuditLogAndJobCardFk
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaysideGarage.Core.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WaysideGarage.Core.Models.EmailQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WaysideGarage.Core.Models.JobCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WaysideGarage.Core.Models.JobCardLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WaysideGarage.Core.Models.JobCard", b =>
                {
                    b.HasOne("WaysideGarage.Core.Models.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("WaysideGarage.Core.Models.JobCardLine", b =>
                {
                    b.HasOne("WaysideGarage.Core.Models.JobCard", "JobCard")
                        .WithMany("Lines")
