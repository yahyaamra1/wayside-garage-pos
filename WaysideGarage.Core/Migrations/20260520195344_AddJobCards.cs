    ...
    public partial class AddJobCards : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobCardLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobCardLines_JobCards_JobCardId",
                        column: x => x.JobCardId,
                        principalTable: "JobCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobCardLines_Parts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCardLines_JobCardId",
                table: "JobCardLines",
                column: "JobCardId");

            migrationBuilder.CreateIndex(
                name: "IX_JobCardLines_PartId",
                table: "JobCardLines",
                column: "PartId");
